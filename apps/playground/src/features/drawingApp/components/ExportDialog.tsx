...
const ExportDialog = ({
  ...
  return (
    ...
    >
      ...
      <DialogContent
        className={tw('w-full bg-[#3E2828] flex flex-col gap-6 md:gap-8 p-6!')}
      >
        <h1
          className={tw(
        ...
        >
          ...
          <CloseIcon
            ...
            className={tw('relative top-1 cursor-pointer text-[28px]!')}
          />
        </h1>

        <div
          className={tw(
            'w-full flex flex-col items-center sm:flex-row gap-6 md:gap-8'
          )}
        >
          ...
          <div
            className={tw('flex text-[#F5EAEA] flex-1 w-full flex-col gap-4')}
          >
            <div className={tw('flex flex-col gap-1')}>
              ...
              <input
                className={tw(
                  'w-full h-10 bg-[#6D4F4F] opacity-70 rounded-md px-3'
                )}
            ...
            <div className={tw('flex flex-col gap-1 mt-3')}>
              ...
              <Select
                ...
                className={tw('w-full rounded-md border-none overflow-hidden')}
                classes={{
                  disabled: tw(
                    'opacity-70! bg-[#6D4F4F]!',
                    css({
                      '&': { WebkitTextFillColor: 'unset !important' },
                    })
                  ),
                  select: tw(
                    'px-3! py-2! bg-[#6D4F4F]! text-[15px]!',
                    css({
